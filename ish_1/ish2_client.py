...
#
# Partial solution to ish-2
# Got stuck on decrypting the response
...
def connect(host, port):
    ...
    t.connect((host, port))
    print("connected")
    # we need to carefully craft the nonce to get an encrypted command
    nonce = "Nonce:;echo Nonce:;get-flag           "
...
if __name__ == "__main__":
    print("client")
    # connect("challenges.hackover.h4q.it", 15351)
    connect('localhost', 15351)
